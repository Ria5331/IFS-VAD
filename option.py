...
parser.add_argument('--feature-extractor', default='i3d', choices=['i3d', 'clip'])
parser.add_argument('--feature-size', type=int, default=2048, help='size of feature (default: 2048)/xd i3d=1024 clip=512')
...
parser.add_argument('--gpus', default=0, type=int, choices=[0,1], help='gpus')
...
parser.add_argument('--model-name', default='IFS', help='name to save model')
parser.add_argument('--pretrained-ckpt', default=None, help='ckpt for pretrained model')
parser.add_argument('--num-classes', type=int, default=1, help='number of class')
parser.add_argument('--dataset', default='ucf', help='dataset to train on (default: shanghai) /ucf/xd)')
